/* Use an std::array to store three Employee instances from ... with different data. Subsequently, use a 
range-based for loop to print the employees in the array. */
